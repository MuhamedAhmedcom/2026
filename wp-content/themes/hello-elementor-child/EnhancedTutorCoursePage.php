...
class EnhancedTutorCoursePage {
    ...
    private function render_enhanced_styles() {
        ...
        * {
        ...
        .completed-btn.course-completed {
            background: #10b981;
            border-color: #10b981;
            opacity: 0.9;
        }
        ...
        .module-lesson-thumbnail img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        }

        .module-lesson-overlay {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
        ...
        /* Filter States */
        .sidebar-lessons-list[data-filter="unwatched"] .sidebar-lesson-card[data-status="watched"],
        .module-lessons-grid[data-filter="unwatched"] .module-lesson-card[data-status="watched"] {
            display: none;
        }

        .sidebar-lessons-list[data-filter="watched"] .sidebar-lesson-card[data-status="unwatched"],
        .module-lessons-grid[data-filter="watched"] .module-lesson-card[data-status="unwatched"] {
            display: none;
        }
        ...
        .tutor-no-video-placeholder h3 {
            margin-bottom: 8px;
            font-size: 24px;
            font-weight: 600;
        }

        .tutor-no-video-placeholder p {
            opacity: 0.9;
            font-size: 16px;
        }

        #videoPlayerArea .tutor-lesson-content-wrap {
            display: none;
        }

        .tutor-lesson-content-wrap .tutor-video,
        .tutor-lesson-content-wrap .tutor-lesson-video,
        .tutor-lesson-content-wrap iframe {
            max-width: 100%;
            height: auto;
        }
